...
export default function ModalGroupSpaces({
  ...
  return (
    <div className={styles.group}>
      <label className={styles.group__label}>Faces</label>
      ...
      <label className={styles.group__label}>Actions</label>
      <p className={styles.group__description}>
        Determines the likelihood of inserting playful actions, such as notices
        buldge, into the text. Higher settings result in more actions, enhancing
        the whimsical aspect.
      </p>
      ...
      <label className={styles.group__label}>Stutters</label>
      <p className={styles.group__description}>
