    ...
    <div class="container">
      <a class="logo-uwuifier" href="/">
        <picture>
          ...
          <img width="30" height="30" src="/logo.png" alt="Uwuifier logo" />
        </picture>
        <span>Uwuifier</span>
      </a>
      <nav>
        <a
          class="github-logo"
          href="https://github.com/Schotsl/Uwuifier-node"
